    ...
    return (
        <>
            ...
            <div className="card info-card">
                ...
                <p>This means that after 5 hours, half the caffeine you consumed is still in your system, keeping you alert longer! So if you dring a cup of coffee with 200 mg of caffeine, 5 hourse later, you&apos;ll still have about 100mg of caffeine in your system</p>
            </div>
        </>
    )
}